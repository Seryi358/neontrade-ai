    ...
    def _build_strategy_steps(self, signal):
        ...
        steps = {
            ...
            "BLACK": [
                ...
                "4. Sobrecompra clara en 4H (precio lejos de EMA 50 4H) + consolidación",
                "5. Patrón de reversión en 1H (triángulo/cuña). RSI divergencia",
                "6. Esperar patrón completo + candlestick de reversión + ruptura en 5M",

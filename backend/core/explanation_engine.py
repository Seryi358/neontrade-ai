    ...
    def _build_strategy_steps(self, signal):
        ...
        steps = {
            ...
            "BLUE_C": [
                ...
                "6. Ejecución en 5M: Rompe, Cierra, Confirma (RCC) — prioridad: EMA 50 5M > diagonal > EMA 2M",
                "7. SL: debajo del 0.618 Fibonacci / debajo del mínimo anterior. TP: máximo/mínimo anterior (swing high/low, NO EMA 50 4H ya que la entrada fue en rechazo de esa EMA). R:R mínimo 2:1 obligatorio",
            ],
            "RED": [
                "1. Nivel de soporte/resistencia en gráfico diario identificado",
                "2. El precio atacó el nivel y desaceleró",
            ...
            "BLACK": [
                ...
                "4. Sobrecompra clara e innegociable en 4H (precio lejos de EMA 50 4H) + consolidación/freno. Extra: RSI sobrecompra + divergencia RSI en 4H",
                "5. Patrón de reversión en 1H (triángulo/cuña, rara vez canal). Si EMA 50 1H actúa como S/R dinámica (3+ rechazos), no hay Black. Extra: MACD divergencia en H1",
                "6. Esperar patrón completo + candlestick de reversión en 1H + Rompe, Cierra, Confirma (RCC) en 5M",
                "7. SL encima del máximo anterior | TP en EMA 50 4H | R:R mínimo 2:1",
            ],
            "GREEN": [

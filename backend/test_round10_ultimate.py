...
ok("cfg_forex_watchlist_no_xauusd", "XAU_USD" not in s.forex_watchlist)
...
ok("cfg_active_watchlist_categories", s.active_watchlist_categories == ["forex", "forex_exotic", "commodities", "indices", "equities", "crypto"])
ok("cfg_allocation_trading_pct", s.allocation_trading_pct == 0.80)
ok("cfg_allocation_forex_pct", s.allocation_forex_pct == 0.90)

...
ok("cfg_drawdown_level_1", s.drawdown_level_1 == 0.05)
ok("cfg_drawdown_level_2", s.drawdown_level_2 == 0.075)
ok("cfg_drawdown_level_3", s.drawdown_level_3 == 0.10)
...
ok("cfg_ema_daily", s.ema_daily == 20)

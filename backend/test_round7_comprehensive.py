...
def block_8_config():
    ...
    check("B8-04 max_total_risk = 0.03", abs(settings.max_total_risk - 0.03) < 1e-9)
    ...
    check("B8-17 XAU_USD not in watchlist", "XAU_USD" not in settings.forex_watchlist)
    check("B8-18 BTC_USD in crypto", "BTC_USD" in settings.crypto_watchlist)
    check("B8-19 drawdown_method = fixed_levels", settings.drawdown_method == "fixed_levels")
